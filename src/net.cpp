...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kilicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"smileyco.in", "dnsseed.smileyco.in"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"smileyco.in", "dnsseed-testnet.smileyco.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kilicoin is probably already running."), addrBind.ToString().c_str());
        else
