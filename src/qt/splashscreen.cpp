    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText3   = QChar(0xA9)+QString(" 2014-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Kilicoin developers"));
    ...
    pixPaint.drawText(paddingLeftCol2,paddingTopCol2+line4,copyrightText3);
